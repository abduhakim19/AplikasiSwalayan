 ...
 * @author hakim
 */
public class produkPanelPenjualan extends javax.swing.JFrame {
     ...
     * @param frame
     */
    public produkPanelPenjualan(penjualan frame) {
        initComponents();
        tabelKategori();
        this.f = frame;
    ...
    private void tabelProdukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelProdukMouseClicked
        ...
        this.f.tHarga.setText(tabelProduk.getModel().getValueAt(baris, 4).toString()); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(produkPanelPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            private penjualan f;
            public void run() {
                new produkPanelPenjualan(this.f).setVisible(true);
            }
        });
    }
