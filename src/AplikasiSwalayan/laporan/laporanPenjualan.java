...
public class laporanPenjualan extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        bPrintAll.setText("Cetak Data Transaksi Penjualan");
        ...
        jLabel8.setText("Laporan Transaksi Penjualan");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("Konsumen\n"));

        jLabel23.setText("ID Konsumen");
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tKodeKonsumen, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void bPrintAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintAllActionPerformed
        ...
        File file = new File("src/Laporan/semuaPenjualan.jrxml");
    ...
    private void tabelPenjualanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelPenjualanMouseClicked
        ...
        try {
            dateView = tglview.parse((String) tabelPenjualan.getValueAt(baris, 5));
        } catch (ParseException ex) {
            Logger.getLogger(laporanPenjualan.class.getName()).log(Level.SEVERE, null, ex);
        }        
        
        tKodeTr.setText(tabelPenjualan.getModel().getValueAt(baris, 0).toString());
        tKodeKaryawan.setText(tabelPenjualan.getModel().getValueAt(baris, 6).toString());
        tNamaKaryawan.setText(tabelPenjualan.getModel().getValueAt(baris,1).toString());
        tKodeKonsumen.setText(tabelPenjualan.getModel().getValueAt(baris, 7).toString());
        tNamaKonsumen.setText(tabelPenjualan.getModel().getValueAt(baris, 2).toString());
    ...
    private void bDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDeleteActionPerformed
        ...
        int ok = JOptionPane.showConfirmDialog(null,"Hapus data ini?","Konfirmasi",JOptionPane.YES_NO_OPTION);
         if (ok==0){
             ...
             String sql = "delete from transaksi_penjualan_detail where kd_transaksi_jual = '"+tKodeTr.getText()+"'";
        
             String sql2 = "delete from transaksi_penjualan where kd_transaksi_jual ='"+tKodeTr.getText()+"'";
             try{
    ...
    private void bCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCariActionPerformed
        // TODO add your handling code here:
        Object header[]={"Kode Transaksi","NAMA KARYAWAN","NAMA KONSUMEN","BAYAR", "TOTAL", "TANGGAL", "kdkar", "kdkons"};
        ...
        try {
            ...
            while (rs.next())
            {
                String kolom1=rs.getString("kd_transaksi_jual");
                String kolom2=rs.getString("nama_karyawan");
                String kolom3=rs.getString("nama_konsumen");
                String kolom4=rs.getString("bayar");
                String kolom5=rs.getString("total");
                String kolom6=rs.getString("tgl_penjualan");
                String kolom7=rs.getString("kd_karyawan");
                String kolom8=rs.getString("kd_konsumen");

                String kolom[]={kolom1,kolom2,kolom3,kolom4,kolom5,kolom6,kolom7,kolom8};
                data.addRow(kolom);
            }
            tabelPenjualan.removeColumn(tabelPenjualan.getColumnModel().getColumn(7));
            tabelPenjualan.removeColumn(tabelPenjualan.getColumnModel().getColumn(6));
        } catch (Exception e) {
